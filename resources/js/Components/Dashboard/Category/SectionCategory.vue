<script setup>
    ...
    const form = useForm({
        ...
        chapter_id: props.category.chapter_id,
    ...
    const urlImage = () =>  form.image != undefined ? URL.createObjectURL(form.image) : props.category.image
    const urlIcon = () =>  form.icon != undefined ? URL.createObjectURL(form.icon) : props.category.icon
                ...
                <q-list class="img-width">
                    <q-item class="no-padding">
                        ...
                        <q-item-section class="items-between col-2">
                            ...
                            <q-btn v-if="category.id" label="Удалить" color="dbrem" class="q-ml-sm" @click.stop.prevent="onDelete" flat no-caps />
                        </q-item-section>
                    </q-item>
                </q-list>
            </q-card-section>
