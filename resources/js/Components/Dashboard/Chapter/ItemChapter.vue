<script setup>
    ...
    // const urlCreate = props.urlCreate
    // const urlUpdate = props.urlUpdate
    // const urlDelete = props.urlDelete
            ...
            <q-card-section>
                <q-list class="img-width">
                    ...
                    <q-item class="raw">
                        ...
                        <q-item-section class="offset-1 col-2">
                            <q-btn v-if="chapter.id" label="Удалить" color="dbrem" class="q-ml-sm" @click.stop.prevent="onDelete"/>
                        </q-item-section>
                    </q-item>
                </q-list>
            </q-card-section>
