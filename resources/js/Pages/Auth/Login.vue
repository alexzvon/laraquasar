    ...
    <GuestLayout>
        ...
        <form @submit.stop.prevent="submit">
            <q-list bordered separator>
                ...
                <q-item class="no-border q-mt-sm">
                    <q-item-section>
                        <q-btn label="Войти" type="submit" class="text-mutan bg-bluies full-width" no-caps/>
                    </q-item-section>
                </q-item>
                <q-item class="no-border q-mt-sm">
                    <q-item-section>
                        <Link :href="route('auth.register')">
                            <q-btn flat label="Зарегистрироваться" class="text-gries bg-btn-none full-width" no-caps/>
                        </Link>
                    </q-item-section>
                </q-item>
